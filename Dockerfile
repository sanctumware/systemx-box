...
##   $ docker build -t tomcat-for-sanctumware-systemx-box .
##
## RUNNING
##   $ docker run -p 8080:8080 tomcat-for-sanctumware-systemx-box
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="duvd01i" \
    STACKSMITH_STACK_NAME="Tomcat for sanctumware/systemx-box" \
...
RUN bitnami-pkg install tomcat-9.0.0.M21-0 --checksum e7682539a808ead2cfe0e4b87425ec542c279c464f800db35689e189d6b21055 -- --username manager --password bitnami
